...
print("\nCau truc file:")
print("- job_type: 1=Daily, 2=Weekly, 3=Month, 4=Quarter, 5=Year")
print("- schema_name: Ten schema (required)")
print("- table_name: Ten bang (required)")
print("- sql_path: Duong dan file SQL")
print("- description: Mo ta")
