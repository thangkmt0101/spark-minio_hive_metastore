...
INNER JOIN silver.silver.dim_date E on A.year = E.year AND A.month = E.month
WHERE E.QUARTER_ID  = '{{ quarter_id }}'
GROUP BY  E.QUARTER_ID, A.CHECKOUT_TOLL_ID, A.VEHICLE_TYPE, C.CYCLE_NAME, D.TOLL_NAME;
