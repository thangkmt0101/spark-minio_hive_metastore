...
A.CHECKOUT_LANE_NAME AS lane_name, -- tên lane
...
GROUP BY A.VEHICLE_TYPE, A.CHECKOUT_TOLL_NAME, A.CHECKOUT_LANE_NAME, B.VEHICLE_GROUP
UNION ALL 
SELECT 
'{{year_utc_7}}-{{quarter_utc_7}}' as quarter_id,
split(A.CHECKOUT_TOLL_NAME, '\\s*-\\s*')[1] AS route, -- tuyến
...
GROUP BY A.checkout_channel, A.CHECKOUT_TOLL_NAME, A.CHECKOUT_LANE_NAME, B.VEHICLE_GROUP